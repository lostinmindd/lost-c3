...
export declare namespace Lost {
    ...
    interface LanguagePluginProperty {
        "name": string;
        "desc": string;
        "items"?: {
            [itemId: string]: string;
...
export declare function Action(Options: Lost.ActionOptions): (target: any, propertyKey: string, descriptor: PropertyDescriptor) => void;
export declare function Condition(Options: Lost.ConditionOptions): (target: Lost.Category, propertyKey: string, descriptor: PropertyDescriptor) => void;
export declare function Expression(Options: Lost.ExpressionOptions): (target: Lost.Category, propertyKey: string, descriptor: PropertyDescriptor) => void;
/**
 * Params
 */
export declare namespace Lost {
    ...
    type ParamOptionsType = ParamOptions | StringParamOptions | ComboParamOptions | ObjectParamOptions;
    ...
    interface StringParamOptions extends ParamOptions {
        /**
    ...
    interface ComboParamOptions extends ParamOptions {
        /**
    ...
    interface ObjectParamOptions extends ParamOptions {
        AllowedPluginIds?: string[];
    }
}
/**
 ...
 * an integer number property, always rounded to a whole number.
 */
export declare class IntegerProperty extends Lost.PluginProperty {
 ...
 * a floating-point number property.
 */
export declare class FloatProperty extends Lost.PluginProperty {
 ...
 */
export declare class PercentProperty extends Lost.PluginProperty {
    constructor(Options: Lost.PercentPropertyOptions);
}
/**
 * @description a field the user can enter a string in to.
 */
export declare class TextProperty extends Lost.PluginProperty {
 ...
 */
export declare class LongTextProperty extends Lost.PluginProperty {
    constructor(Options: Lost.LongTextPropertyOptions);
}
/**
 * @description a checkbox property, returning a boolean.
 */
export declare class CheckProperty extends Lost.PluginProperty {
 ...
 */
export declare class FontProperty extends Lost.PluginProperty {
 ...
 */
export declare class ComboProperty extends Lost.PluginProperty {
 ...
 */
export declare class ColorProperty extends Lost.PluginProperty {
 ...
 */
export declare class ObjectProperty extends Lost.PluginProperty {
 ...
 */
export declare class GroupProperty extends Lost.PluginProperty {
