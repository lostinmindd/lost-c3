import { Param, IParamOptions, NumberParam, StringParam, AnyParam, ParamType } from "./lost-params";

export function Deprecate(entity: Lost.Action.IAction | Lost.Condition.ICondition | Lost.Expression.IExpression) {
    entity.Options.IsDeprecated = true;
    return entity;
}
...
export namespace Lost {
    ...
    export namespace LanguageJSON {
        ...
        export interface ILanguageCondition {
            /**
             * @description
        ...
        export interface ILanguageExpression {
            /**
             * @description
        ...
        export interface ILanguagePluginProperty {
            "name": string;
            "desc": string;
            "items"?: {
                [itemId: string]: string;
    ...
    export namespace Entity {
        ...
        export interface IEntity {
            Id: string;
            Name: string;
            DisplayText: string; // Set document title to [b]{0}[/b]
            Description?: string;
            Options: IOptions;
        }
