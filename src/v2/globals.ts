...
export const BUILD_FOLDER = 'build/lost';
...
export const BEHAVIOR_BONES_FOLDER_PATH = path.resolve(__dirname, '../../src/addon/behavior/dist');
...
export const MAIN_BEHAVIOR_JS_PATH = path.resolve(`${ADDON_FOLDER}/behavior.js`);
